...
public interface WantedService {
    ...
    //找到所有悬赏信息
    List<Wanted> getAllWanteds(Integer offset);
    //找到某个接受人接受的所有悬赏信息
    ...
    List<Wanted> getAllWantedsByStatus(Integer status, Integer offset);
    //找到搜索的类似标题的悬赏信息
    List<Wanted> getAllWantedsByTitle(String title, Integer offset);
}
