...
public interface WantedMapper {
    ...
    //找到所有悬赏信息
    List<Wanted> findAllWanteds(@Param(value = "offset") Integer offset);
    //找到某个接受人接受的所有悬赏信息
    ...
    List<Wanted> findAllWantedsByStatus(@Param(value = "status") Integer status, @Param(value = "offset") Integer offset);
    //找到搜索的类似标题的悬赏信息
    List<Wanted> findAllWantedsByTitle(@Param(value = "title") String title, @Param(value = "offset") Integer offset);
}
